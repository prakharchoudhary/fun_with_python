...
stdout/stdin--my reads and writes maop to output and input streams of the
...
def spawn(prog, *args):
	...
	if pid:
		...
		os.close(parentStdout)					# close parent end in child
...
if __name__ == '__main__':
	...
	print('Hello 1 from parent', mypid)					# to find the child's stdin
